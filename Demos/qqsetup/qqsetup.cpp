...
#include "resource.h"
#include <ShellAPI.h>
class CMainFrame : public CWindowWnd, public INotifyUI, public CWebBrowserEventHandler
{
public:
	CMainFrame() {
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
...
#else
	CPaintManagerUI::SetResourcePath(CPaintManagerUI::GetInstancePath() + _T("skin\\qqsetup"));//
	...
	pFrame->Create(NULL, _T("软件选项"), UI_WNDSTYLE_FRAME, 0L, 0, 0, 800, 572);
	pFrame->CenterWindow();
