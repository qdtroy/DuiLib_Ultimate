...
namespace DuiLib {
	...
	SIZE CLabelUI::EstimateSize (SIZE szAvailable) {
		if (m_bAutoCalcWidth) {
			...
			int nLinks = 0;
			if (m_bShowHtml) CRenderEngine::DrawHtmlText (m_pManager->GetPaintDC (), m_pManager, rcText, sText, m_dwTextColor, nullptr, nullptr, nLinks, m_iFont, DT_CALCRECT | m_uTextStyle);
